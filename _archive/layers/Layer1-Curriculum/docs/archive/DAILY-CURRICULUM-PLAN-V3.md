# Layer 1: The Mechanic-Level AI Engineer — Day-by-Day Curriculum (V3)
...
> **SQL Gap Note**: 17% of AI Engineer job postings require SQL skills. This curriculum doesn't cover SQL — it's out of scope for the Mechanic track. If you're not comfortable with SQL, spend 4 hours on [SQLZoo](https://sqlzoo.net/) or [Mode Analytics SQL Tutorial](https://mode.com/sql-tutorial/) before starting this curriculum or during your Days 39–40 buffer. At minimum, know: SELECT/WHERE/JOIN/GROUP BY, subqueries, and how to read query plans.
