...
**Purpose:** Guide AI assistants (ChatGPT, Claude, etc.) to teach effectively
**Status:** ⚠️ **REFERENCE ONLY — Use LAYER1-FINAL for canonical guide**
...
**This guide is preserved for reference. Use LAYER1-FINAL for canonical teaching guide.**

**→ Use This Instead:** [`../../LAYER1-FINAL/GUIDE-FOR-AI-ASSISTANTS.md`](../../LAYER1-FINAL/GUIDE-FOR-AI-ASSISTANTS.md)

**What's Different in LAYER1-FINAL:**
- ✅ Curriculum-specific guidance (which week, what to expect)
- ✅ Phase-specific checkpoint questions with expected answers
- ✅ Standardized rubrics (scoring 0-5 with clear criteria)
- ✅ Git collaboration workflow integration
- ✅ COST-LOG and FAILURE-LOG enforcement
