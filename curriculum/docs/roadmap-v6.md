...
**Time**: 9.5 hours total | **Status**: 🆕 NEW
...
### Chapter 22: Advanced RAG Patterns & Incremental Indexing
**Time**: 2.0 hours | **Type**: Implementation | **Difficulty**: ⭐⭐⭐

**What You'll Build**: Parent Document Retriever, HyDE, and an Incremental Indexing system.

**Learning Objectives**:
- Retrieve parent documents for better context
- Auto-merge related chunks
- Implement hypothetical document embeddings (HyDE)
- **Implement hash-based change detection (Incremental RAG)**
...
**Key Concepts**: Parent retriever, auto-merging, multi-vector, HyDE, incremental indexing

**Correctness Properties**: [P29: Parent-child relationship integrity, P30: Change detection accuracy]
...
## Phase 7: LlamaIndex (Chapters 35-38, 38A) 🦙
**Time**: 8.5 hours total | **Status**: 🆕 NEW
...
### Chapter 38A: GraphRAG & Knowledge Graphs
**Time**: 2.5 hours | **Type**: Implementation | **Difficulty**: ⭐⭐⭐⭐
...
**Prerequisites**: Chapter 38 (Hybrid Search)

**Builds Toward**: Chapter 53 (Compliance Review)

**Key Concepts**: Knowledge graphs, graph databases (Neo4j), entity extraction, hybrid retrieval

**Correctness Properties**: [P80: Graph completeness, P81: Relationship accuracy]

---

## Phase 8: Production (Chapters 39-42, 40A-C) 🚀
**Time**: 9.5 hours total | **Status**: 🆕 NEW
...
### Chapter 40A: Evaluation with LangSmith
**Time**: 1.5 hours | **Type**: Implementation | **Difficulty**: ⭐⭐⭐
...
### Chapter 40B: Production Observability with Arize Phoenix
**Time**: 2.0 hours | **Type**: Implementation | **Difficulty**: ⭐⭐⭐⭐
...
- Trace full RAG pipelines
- Identify bottlenecks (latency)
- Monitor token usage & costs per trace

**Prerequisites**: Chapter 40A (Evaluation)

**Builds Toward**: Chapter 54 (Complete System)

**Key Concepts**: Observability, OpenTelemetry, tracing, Phoenix SDK, bottleneck analysis

**Correctness Properties**: [P82: Trace completeness, P83: Latency measurement accuracy]

---

### Chapter 40C: Distributed Tracing & Cost Analytics
**Time**: 1.5 hours | **Type**: Implementation | **Difficulty**: ⭐⭐⭐⭐
...
**Prerequisites**: Chapter 40B (Phoenix)

**Builds Toward**: Chapter 54 (Complete System)

**Key Concepts**: Distributed tracing, correlation IDs, OpenTelemetry, cost analytics
...
## Phase 9: Multi-Agent Systems (Chapters 43-48, 48A) 👥
**Time**: 10.5 hours total | **Status**: 🆕 NEW
...
**What You'll Build**: Message passing, shared memory, and pub/sub for agent communication.

**Learning Objectives**:
- Implement message queues
- Use shared memory/state (Blackboard Pattern)
- Add event-driven communication (Pub/Sub)
...
**Key Concepts**: Message passing, shared state, events, async, blackboard
...
**Key Concepts**: Swarm pattern, peer-to-peer agents, handoffs, agent transfer

**Correctness Properties**: [P86: Handoff accuracy, P87: Agent reachability]

---

## Phase 10: Civil Engineering Application (Chapters 49-54, 52A) 🏗️
**Time**: 11.5 hours total | **Status**: 🆕 NEW - Apply everything to real project
...
### Chapter 52A: Multimodal AI for Civil Engineering
**Time**: 2.5 hours | **Type**: Application | **Difficulty**: ⭐⭐⭐⭐

**What You'll Build**: Multimodal AI system that analyzes CAD drawings, site photos, and generates compliance reports.
...
**Builds Toward**: Chapter 53 (Compliance)

**Key Concepts**: Multimodal LLMs, GPT-4 Vision, CAD analysis, site inspection
...
**What You'll Build**: Agent that reviews documents and drawings for regulatory compliance.

**Learning Objectives**:
- Build compliance checker
- Check against regulations (FAR, OSHA, ASCE standards)
- **Implement visual compliance checking (CAD/Site photos)**
- **Auto-generate RFIs for missing information**
- Generate compliance reports

**Prerequisites**: Chapter 26-30 (agents), Chapter 50-52A (document generation)

**Builds Toward**: Complete system (Ch 54)

**Key Concepts**: Compliance checking, regulatory review, standards validation, visual inspection
...
**Learning Objectives**:
- Integrate all components (including CAD & Multimodal)
- Build Streamlit UI
- **Implement CAD integration (Script generation)**
...
**Key Concepts**: System integration, UI, version control, export, deployment, CAD integration
...
| P30 | Change detection accuracy | 22 |
...
| P55 | Evaluation reproducibility | 40A |
